...
export default function Home() {
  ...
  return (
    <div className="w-full h-screen flex flex-col">
      {/* Navbar */}
      <nav className="w-full h-[8vh] min-h-[48px] flex items-center justify-between px-8 bg-[#fefdf7] text-black border-b-3 border-b-black">
        ...
        {/* Right side: Title and other links */}
        <Link
          href="/"
          className="text-4xl font-bold font-helvetica-now-display transition px-4 py-1 rounded cursor-pointer select-none group"
          aria-label="Home"
        >
          <span className="text-[#f60001] group-hover:text-[#f60001]/80">
            mecha
          </span>
          <span className="text-black group-hover:text-gray-600">verse</span>
        </Link>
